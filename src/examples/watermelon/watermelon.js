...
class Watermelon extends Box2DGame {
    constructor(renderer) {
        ...
        this.graphicAssets = {
            bg:     { path: 'src/examples/watermelon/assets/watermelon_bg.avif',  img: null },
            jar:    { path: 'src/examples/watermelon/assets/watermelon_jar.avif', img: null },
            fruits: { path: 'src/examples/watermelon/assets/watermelon.png', img: null }
        };

        this.audioAssets = {
            backgroundMusic: { path: "src/examples/watermelon/assets/Glass_Pieces_at_Noon.mp3" }
        };
...
class WatermelonUI extends HTMLMenu {
    ...
    Start() {
        ...
        // Restore saved mute icon (volume is applied in Watermelon.Start()
